...
[cols=7,width="100%",options="header"]
|===
|应用 |端口 |角色 |实现模块 |主页地址 |会话时长 |备注
...
|30 分钟
|客户端凭据：oidc-sp-2/secret
|===

NOTE: 不推荐使用 localhost，参考 https://tools.ietf.org/html/draft-ietf-oauth-v2-1-01#section-9.7.1[draft-ietf-oauth-v2-1-01^]，可以使用 127.0.0.1 替代
